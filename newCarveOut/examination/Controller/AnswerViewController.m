...
- (YJAnswerPopTopView *)topView {
    if (!_topView) {
        ...
        _topView.frame = CGRectMake(0, self.view.frame.size.height - 40, CGRectGetWidth(self.collectionView.frame), 40);
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height -40) collectionViewLayout:layout];
