...
+(instancetype)shareManager
{
    ...
    static YSNetWorkManager * manager = nil;
...
-(instancetype)initWithBaseURL:(NSURL *)url{
    if (self = [super initWithBaseURL:url]) {
        ...
        NSDictionary *headerFieldValueDictionary = @{@"version":[[[NSBundle mainBundle]infoDictionary] objectForKey:@"CFBundleShortVersionString"],@"client":@"ios"};
    ...
    switch (type) {
        ...
        case HttpRequestTypeGet:
        {
            ...
            [[YSNetWorkManager shareManager] GET:urlString parameters:paraments progress:^(NSProgress * _Nonnull downloadProgress) {
                ...
                JLMRequsetInfoModel * model = [JLMRequsetInfoModel modelWithDictionary:responseObject[@"info"]];
                successBlock(model);
...
//    [manager.responseSerializer setAcceptableContentTypes:[NSSet setWithObjects:@"text/plain",@"application/json",@"text/json",@"text/javascript",@"text/html",@"multipart/form-data", nil]];
...
//
//            //拼接data
//            [formData appendPartWithFileData:imgData name:[NSString stringWithFormat:@"picflie%ld",(long)i] fileName:@"image.png" mimeType:@"image/png"];
//
//            i++;
//        }
//
