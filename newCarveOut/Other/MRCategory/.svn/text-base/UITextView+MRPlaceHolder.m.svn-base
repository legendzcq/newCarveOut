...
#import "UITextView+MRPlaceHolder.h"
...
- (void)updatePlaceHolder{
    ...
    self.zw_placeHolderLabel.font = kFont(11);
    self.zw_placeHolderLabel.textColor = [UIColor colorWithHexString:@"bababa"];
//    self.font?self.font:self.cacutDefaultFont;
