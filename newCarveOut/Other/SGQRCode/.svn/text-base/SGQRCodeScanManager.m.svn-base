...
/** 扫描内容的 W 值 */
#define scanViewW 0.7 * kWidth
/** 扫描内容的 x 值 */
#define scanViewX 0.5 * (1 - 0.7) * kWidth
#define scanViewY 0.25 * (kHeight-64)
#define scanViewH scanViewW/kHeight
...
//    {62.20000000000001, 154.40000000000001}>,
//    <LineTo {351.79999999999995, 154.40000000000001}>,
//    <LineTo {351.79999999999995, 444}>,
//    <LineTo {62.20000000000001, 444}>,
...
- (void)setupSessionPreset:(NSString *)sessionPreset metadataObjectTypes:(NSArray *)metadataObjectTypes currentController:(UIViewController *)currentController {
    ...
    metadataOutput.rectOfInterest=[self.videoPreviewLayer metadataOutputRectOfInterestForRect:CGRectMake(scanViewX, scanViewY, scanViewW, scanViewW)];
    NSLog(@"%f",scanViewY);
    // 4、创建会话对象
