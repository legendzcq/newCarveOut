...
/** 扫描内容的 Y 值 */
#define scanBorderY (0.25 * (kHeight-64))-64
...
- (void)initialization {
    ...
    _borderColor = [UIColor colorWithRed:8/255.0f green:144/255.0 blue:247/255.0 alpha:1.0];
//    [UIColor whiteColor];
    _cornerLocation = CornerLoactionDefault;
    _cornerColor = [UIColor colorWithRed:8/255.0f green:144/255.0 blue:247/255.0 alpha:1.0];
//    _cornerColor =
//    0890f7
//    [UIColor blueColor];
//    [UIColor colorWithRed:85/255.0f green:183/255.0 blue:55/255.0 alpha:1.0];
    _cornerWidth = 2.0;
