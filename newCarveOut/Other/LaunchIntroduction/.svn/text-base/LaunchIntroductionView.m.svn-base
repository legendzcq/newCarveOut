...
-(void)createScrollView{
    ...
    for (int i = 0; i < images.count; i ++) {
        ...
        if (i == images.count - 1) {
            ...
            if (!isScrollOut) {
                ...
                [enterButton setTitleColor:[UIColor colorWithHexString:@"eec306"] forState:UIControlStateNormal];
                enterButton.layer.borderWidth = 1.0f;
                enterButton.layer.borderColor = [UIColor colorWithHexString:@"eec306"].CGColor;
    ...
    page = [[UIPageControl alloc] initWithFrame:CGRectMake(0, enterBtnFrame.origin.y-36-10, kScreen_width, 30)];
