 ...
 *  Badge样式
 */
typedef NS_ENUM(NSInteger, YSTabItemBadgeStyle) {
    YSTabItemBadgeStyleNumber = 0, // 数字样式
    YSTabItemBadgeStyleDot = 1, // 小圆点
};

@interface YSTabItem : UIButton
 ...
 *  在YSTabBar的属性itemFontChangeFollowContentScroll == YES时会用到
 */
...
/**
 *  当badgeStyle == YSTabItemBadgeStyleNumber时，可以设置此属性，显示badge数值
 *  badge > 99，显示99+
 ...
 *  badge的样式，支持数字样式和小圆点
 */
@property (nonatomic, assign) YSTabItemBadgeStyle badgeStyle;
