...
@interface YSTabBarController : UIViewController <YSTabBarDelegate>

@property (nonatomic, strong, readonly) YSTabBar *tabBar;
...
@interface UIViewController (YSTabBarController)

@property (nonatomic,   copy) NSString *ys_tabItemTitle; // tabItem的标题
@property (nonatomic, strong) UIImage *ys_tabItemImage; // tabItem的图像
@property (nonatomic, strong) UIImage *ys_tabItemSelectedImage; // tabItem的选中图像
...
/**
 *  废弃，用YS_tabItemDidSelected:替换
 */
- (void)tabItemDidSelected __deprecated_msg("废弃，用YS_tabItemDidSelected:替换");

/**
 *  废弃，用YS_tabItemDidDeselected替换
 */
- (void)tabItemDidDeselected __deprecated_msg("废弃，用YS_tabItemDidDeselected替换");
